...
public enum MipsJumpFormatter implements org.parker.mips.architectures.mips.assembler.instructions.formatter.MipsJumpFormatter {
    ...
    public void encode(byte[] data, StandardInstruction instruction, BaseAssembler assembler){
        ...
        //Operand Order o,i
        org.parker.mips.architectures.mips.assembler.instructions.formatter.MipsJumpFormatter.super.encode(data, new int[]{opCode, im}, assembler);
    }
