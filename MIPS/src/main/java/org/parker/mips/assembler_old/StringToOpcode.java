...
public class StringToOpcode {
    ...
    public static byte[] stringToOpcode(AssembleTimeUserLine ctul) throws InvalidOpCodeException, InvalidArgumentsException {
        ...
        if (getNumberOfArguments(new UserLine(opCodeString, ctul.ul.realLineNumber)) != parameter.length) {
            throw new org.parker.mips.assembler_old.InvalidArgumentsException("Wrong number of arguments used for (" + opCodeString + ") needed "
    ...
    private static int decodeRegister(String parameter) throws InvalidArgumentsException {
        if (!parameter.contains("$")) {
            throw new org.parker.mips.assembler_old.InvalidArgumentsException("Invalid register does not contain $", currentLine);
        }
        try {
            return Assembler.parseInt(parameter.replace("$", ""));
        } catch (Exception e) {
            throw new org.parker.mips.assembler_old.InvalidArgumentsException("Invalid register number", currentLine, e);
    ...
    private static int decodeMemoryOpPointerAddress(String parameter) throws InvalidArgumentsException {
        ...
        try {
            ...
            throw new org.parker.mips.assembler_old.InvalidArgumentsException("Invalid Memory Pointer", currentLine, e);
        }
    }
