...
public class UNDEF extends Statement {
    ...
    public UNDEF(UserLine line, ArrayList<Statement> statements) {
        ...
        if (identifire.contains(" ")) {
            LOGGER.log(AssemblerLogLevel.ASSEMBLER_ERROR, "Cannot Have Spaces In Name", line);
        } else {
            ...
            LOGGER.log(AssemblerLogLevel.ASSEMBLER_ERROR,this.IDENTIFIRE + " does not exist", line);
        }
    }
