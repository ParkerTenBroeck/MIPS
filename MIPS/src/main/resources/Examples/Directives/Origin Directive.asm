...
;the following code will be placed starting at address 8 then the rest of the list of addi $10, $10, 1

.org 32 ;this is used to set the origin of the following code
