...
blez $2, lessThanOrEqual ;checks if $2 is greater than zero or less than / equal

llo $4, string1 ;prints string for greater than
addi $5, $0, 1
trap 4
j end

lessThanOrEqual:
llo $4, string2 ;prints string for lessThanOrEqual
addi $5, $0, 1
trap 4
